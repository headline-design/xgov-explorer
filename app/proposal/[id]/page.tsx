          ...
          <Tooltip>
            ...
            <TooltipContent side="left">
              <p className="text-sm max-w-[250px]">
                This unique gradient was generated from the proposal ID hash,
                creating a visual fingerprint for this proposal.
              </p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
          ...
          <div className="md:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                By {proposal.team} • {proposal.xGovPeriod} • Awarded{" "}
              ...
              <div className="p-4 rounded-lg border bg-card">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <span className="text-sm text-muted-foreground ml-2">
                    (
                    {Math.round(
                      (proposal.voteResult.votesReceived /
                        proposal.voteResult.votesNeeded) *
                        100
                    )}
                    % of required votes)
                  </span>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="font-medium">
                      {proposal.voteResult.votesReceived.toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-muted-foreground">
                    ...
                    <div className="font-medium">
                      {proposal.voteResult.votesNeeded.toLocaleString()}
                    </div>
                  </div>
                </div>
                <div className="mt-3">
                  ...
                  (proposal.longDescription.includes("<") ? (
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: proposal.longDescription,
                      }}
                    />
                  ) : (
              ...
              <div>
                ...
                <div className="space-y-4">
                  {proposal.milestones.map((milestone, index) => (
                    <div
                      key={index}
                      className="border-l-2 pl-4 pb-2 dark:border-primary/50"
                    >
                ...
                <div>
                  ...
                  <div className="font-bold">
                    {proposal.fundingAmount > 0
                      ? `${proposal.fundingAmount.toLocaleString()} ALGO`
                      : "Core Proposal"}
                  </div>
                </div>
                <div>
            ...
            <div className="bg-card rounded-lg border p-4">
              ...
              <div className="text-muted-foreground">
                ...
                <Button variant="link" className="p-0 h-auto mt-2" asChild>
                  <Link
                    href={`/teams?team=${encodeURIComponent(proposal.team)}`}
                  >
