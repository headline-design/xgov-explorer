          ...
          <div className="space-y-8 md:space-y-12">
              ...
              <div className="divide-y rounded-xl border bg-card shadow-sm dark:shadow-md dark:shadow-primary/5 dark:divide-border">
                <FaqItem question="What is the Algorand xGov program?" defaultOpen={true}>
                  <p className="mb-4">
                    ...
                    to empower the Algorand community to propose, fund, and build proposals that enhance the Algorand
                    ecosystem.
                  </p>
                  <p>
                    Through xGov, community members can submit proposals for proposals that address specific needs or
                ...
                <FaqItem question="How does xGov differ from regular Algorand Governance?">
                  ...
                  <p>
                    ...
                    members to propose and execute proposals that contribute to the growth and development of the
                ...
                <FaqItem question="What types of proposals are funded through xGov?">
                  <p className="mb-4">
                    The xGov program funds a diverse range of proposals that contribute to the Algorand ecosystem,
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Gaming and metaverse proposals</li>
            ...
            <div className="space-y-5">
              ...
              <div className="divide-y rounded-xl border bg-card shadow-sm dark:shadow-md dark:shadow-primary/5 dark:divide-border">
                ...
                <FaqItem question="What is the typical funding amount for xGov proposals?">
                  <p className="mb-4">
                    Funding amounts for xGov proposals vary widely depending on the scope, complexity, and potential
                    impact of the proposed proposal. Typically, proposals can receive anywhere from 10,000 to 500,000 ALGO
                    or more.
                  </p>
                  <p>
                    ...
                    of each proposal&apos;s value proposition.
                  </p>
                </FaqItem>
            ...
            <div className="space-y-5">
              ...
              <div className="divide-y rounded-xl border bg-card shadow-sm dark:shadow-md dark:shadow-primary/5 dark:divide-border">
                <FaqItem question="Do xGov proposals need to be built exclusively on Algorand?">
                  <p>
                    Yes, xGov proposals must be built on the Algorand blockchain or directly contribute to the Algorand
                    ecosystem. The primary goal of the xGov program is to foster growth and innovation within the
                    Algorand ecosystem, so funded proposals should leverage Algorand&apos;s technology and contribute to its
                ...
                <FaqItem question="What technical resources are available for xGov developers?">
                  <p className="mb-4">
                    Developers working on xGov proposals have access to a wide range of technical resources, including:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <Link
                ...
                <FaqItem question="How are milestones and deliverables tracked for funded proposals?">
                  <p className="mb-4">Funded xGov proposals typically follow a milestone-based approach:</p>
                  <ol className="list-decimal pl-6 space-y-2">
                    <li>Proposals define clear milestones and deliverables in their proposals</li>
                  ...
                  <p className="mt-4">
                    This structured approach ensures accountability and increases the likelihood of successful proposal
                    completion.
                  </p>
                </FaqItem>

                <FaqItem question="Can existing proposals apply for xGov funding?">
                  <p>
                    Yes, existing proposals can apply for xGov funding to expand their features, improve their
                    ...
                    proposals. These teams can leverage their experience and track record to strengthen their proposals.
                  </p>
                </FaqItem>
              </div>
            </div>
              ...
              <div className="divide-y rounded-xl border bg-card shadow-sm dark:shadow-md dark:shadow-primary/5 dark:divide-border">
                <FaqItem question="How can I get involved with xGov without submitting a proposal?">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Help test and provide feedback on developed proposals</li>
                    <li>Spread awareness about successful xGov proposals</li>
                  </ul>
                </FaqItem>
                ...
                <FaqItem question="How does xGov contribute to Algorand's ecosystem growth?">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>Funding innovative proposals that address gaps in the ecosystem</li>
                    ...
                    <li>Fostering collaboration between different proposals and teams</li>
