...
export function ProjectDetailView({ project, closeModal }: ProjectDetailViewProps) {
    ...
    <>
      <DialogHeader className="sticky top-0 z-10 bg-background p-4">
        <div className="flex items-center justify-start">
          <DialogTitle className="text-2xl whitespace-nowrap text-ellipsis overflow-hidden">{project.title}</DialogTitle>
